...
function set_custom_package_perms()
{
	...
	if [ $exists_smartdock -eq 1 ]; then
		...
		pm grant --user 0 cu.axel.smartdock android.permission.WRITE_SECURE_SETTINGS
		appops set cu.axel.smartdock WRITE_SECURE_SETTINGS allow
		pm grant cu.axel.smartdock android.permission.WRITE_SETTINGS
		pm grant --user 0 cu.axel.smartdock android.permission.WRITE_SETTINGS
		...
		pm grant --user 0 cu.axel.smartdock android.permission.BIND_ACCESSIBILITY_SERVICE
		...
		pm grant --user 0 cu.axel.smartdock android.permission.BIND_NOTIFICATION_LISTENER_SERVICE
		...
		pm grant --user 0 cu.axel.smartdock android.permission.BIND_DEVICE_ADMIN
		...
		pm grant --user 0 cu.axel.smartdock android.permission.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS
	...
	if [ $exists_taskbar -eq 1 ]; then
		...
		pm grant --user 0 com.farmerbb.taskbar android.permission.WRITE_SECURE_SETTINGS
		...
		pm grant --user 0 com.farmerbb.taskbar android.permission.BIND_ACCESSIBILITY_SERVICE
		appops set com.farmerbb.taskbar BIND_ACCESSIBILITY_SERVICE allow
		pm grant --user 0 com.farmerbb.taskbar android.permission.MANAGE_OVERLAY_PERMISSION
	...
	if [ $is_microg -eq 1 ]; then
		...
		if [ $exists_gms -eq 1 ]; then
			...
			pm grant --user 0 com.google.android.gms android.permission.MICROG_SPOOF_SIGNATURE
			appops set com.google.android.gms android.permission.MICROG_SPOOF_SIGNATURE
			pm grant --user 0 com.google.android.gms android.permission.WRITE_SECURE_SETTINGS
			...
			pm grant --user 0 com.google.android.gms android.permission.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS
		...
		if [ $exists_vending -eq 1 ]; then
			pm grant --user 0 com.google.android.vending android.permission.FAKE_PACKAGE_SIGNATURE
